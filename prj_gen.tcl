...
#
# prj_gen.tcl: Tcl script for re-creating project 'ps_bram'
#
# Generated by Vivado on Sun Jul 28 14:11:58 CST 2024
...
#
# 1. This project restoration tcl script (prj_gen.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/yunlang/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/yunlang/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/ip/myip_0/myip_0.xci"
#    "/home/yunlang/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/ip/myip_1/myip_1.xci"
#
...
set orig_proj_dir "[file normalize "$origin_dir/work/csp/zynq/ps_bram"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/work/csp/temp/ip_repo"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/ip/myip_0/myip_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/work/csp/zynq/ps_bram/ps_bram.srcs/sources_1/ip/myip_1/myip_1.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__IRQ_P2F_LPD_APB__INT {1} \
  ...
  connect_bd_net -net pl_bram_ctrl_0_intr [get_bd_pins pl_bram_ctrl_0/intr] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins pl_bram_ctrl_0/s00_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-404,-179",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 660 -y -20 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 1 -x -150 -y 90 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 2 -x 210 -y 120 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1170 -y 490 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 4 -x 1170 -y 250 -defaultsOSRD
preplace inst pl_bram_ctrl_0 -pg 1 -lvl 1 -x -150 -y 290 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 -310 10 -10 20 350 80 960
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 3 1 970 -30n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 5 -300 370 N 370 N 370 970 350 1350
preplace netloc pl_bram_ctrl_0_intr 1 1 2 0 10 340J
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 1 1 -10 90n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 3 1 980 -50n
preplace netloc axi_smc_M00_AXI 1 0 5 -320 0 N 0 330 90 N 90 1360
preplace netloc pl_bram_ctrl_0_BRAM_PORT 1 1 1 10 130n
preplace netloc axi_smc_M01_AXI 1 0 5 -290 380 NJ 380 NJ 380 NJ 380 1350
levelinfo -pg 1 -340 -150 210 660 1170 1390
pagesize -pg 1 -db -bbox -sgen -340 -270 1390 1290
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xazu3eg-sfvc784-1-i -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xazu3eg-sfvc784-1-i -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
